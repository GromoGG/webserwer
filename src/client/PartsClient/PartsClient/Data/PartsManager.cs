...
namespace PartsClient.Data
{
       public static class PartsManager
       {
              ...
              static readonly string BaseAddress = "https://mslearnpartsserver302343282.azurewebsites.net";
              ...
              public static async Task<Part> Add(string partName, string supplier, string partType,double Price)
              {
                     if (Connectivity.Current.NetworkAccess != NetworkAccess.Internet)
                            return new Part();
